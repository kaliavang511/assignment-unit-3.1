...
let favoriteFoods = ['pizza', 'pho', 'kfc'];
...
let lastAnimal1 = animalArray.length -1;
console.log('The last animal is', animalArray[lastAnimal1]);
...
console.log('Dessert added to end', favoriteFoods);
...
console.log(`Entree added to beginninng: ${favoriteFoods}`);
...
console.log('separated by the word "and":', gemString);
...
console.log('Added colors to gems:', colorfulGems);
