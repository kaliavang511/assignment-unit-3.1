...
let favoriteFoods = ['hotdogs', 'pho', 'noodles']
...
// animalArray.length
lastAnimal1 = animalArray.length -1;
console.log(animalArray[lastAnimal1]);
...
console.log('dessert added', favoriteFoods);
...
console.log('entree added ', favoriteFoods);
...
console.log('RM first color', firstColor);
...
let gemString = "Tourmaline and Topaz and Tanzanite and Iolite and Emerald and Diamond";
